...
pub const Stash = struct {
    ...
    pub fn stashCreate(allocator: std.mem.Allocator, size: usize) !Stash {
    ...
    pub fn stashDestroy(self: *Stash, allocator: std.mem.Allocator) void {
        const slice = self.ptr[0..self.total_size];
