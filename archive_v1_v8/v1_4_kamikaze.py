...
# =================================================================
# KESSLER V1.4: KAMIKAZE PROTOCOL (FUSION MARKETS)
# High-Leverage Hyper-Compounding Execution
# =================================================================

SYMBOL = "NQ=F"
TIMEFRAME = "5m"
RISK_PCT = 25.0  # Kamikaze Hyper-Compounding
ACCOUNT_BALANCE = 60.0 # $60 Initial Deposit
...
class KesslerPsycheEngine:
    ...
    def generate_payload(self, direction, atr):
        ...
        CONTRACT_MULTIPLIER = 1.0  # Default assumption for Fusion Markets
        volume = risk_amount / (sl_dist * CONTRACT_MULTIPLIER)
        
        volume = round(volume, 2)
        if volume < 0.01: volume = 0.01
        if volume > 50.0: volume = 50.0 # Standard Ceiling
